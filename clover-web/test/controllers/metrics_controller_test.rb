...
class MetricsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create metric" do
    assert_difference('Metric.count') do
      post metrics_url, params: { metric: { measurement_name: @metric.measurement_name, metric_source_id: @metric.metric_source_id, value_field: @metric.value_field } }
    end
  ...
  test "should update metric" do
    patch metric_url(@metric), params: { metric: { measurement_name: @metric.measurement_name, metric_source_id: @metric.metric_source_id, value_field: @metric.value_field } }
